...
```sh
# Use "next" branch
npx create-remix@latest --install --template https://github.com/heisonyee/epic-stack/tree/next
# Use pnpm
pnpm create remix@latest --template https://github.com/heisonyee/epic-stack/tree/next
```
